...
2. Build a custom image:
   ...
   docker push relu/relu:0.1.3.28
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `relu/relu:___`)
...
3. Push the new version: `docker push relu/relu:0.1.3`
