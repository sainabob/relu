                  ...
                  {activeTab === 'imprint' ? (
                    ...
                    <div>
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to Relu AI Corp (701 Tillery Street
                        ...
                        <li>
                          "Service" refers to the Relu website and all related
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to info@relu.work and we will process and
