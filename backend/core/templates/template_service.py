...
class ReluDefaultAgentTemplateError(Exception):
    pass
...
class TemplateService:
    ...
    async def create_from_agent(
        ...
        if self._is_relu_default_agent(agent):
            raise ReluDefaultAgentTemplateError("Cannot create template from Relu default agent")
    ...
    async def get_public_templates(
        self,
        is_relu_team: Optional[bool] = None,
        ...
        if is_relu_team is not None:
            query = query.eq('is_relu_team', is_relu_team)
    ...
    def _is_relu_default_agent(self, agent: Dict[str, Any]) -> bool:
        metadata = agent.get('metadata', {})
        return metadata.get('is_relu_default', False)
    ...
    def _map_to_template(self, data: Dict[str, Any]) -> AgentTemplate:
        ...
        return AgentTemplate(
            ...
            is_relu_team=data.get('is_relu_team', False),
