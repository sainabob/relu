...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create Relu Workers with custom Knowledge, Tools & Integrations',
      ...
      'Relu Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create Relu Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create Relu Workers with custom Knowledge, Tools & Integrations',
