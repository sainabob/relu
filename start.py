...
def print_manual_instructions(compose_cmd_str):
    """Prints instructions for manually starting Relu services."""
    progress = load_progress()
    ...
    print("To start Relu, you need to run these commands in separate terminals:\n")
    ...
    print("Once all services are running, access Relu at: http://localhost:3000\n")
...
def main():
    ...
    if "--help" in sys.argv:
        ...
        print("Manage Relu services based on your setup method")
        print("\nOptions:")
    ...
    if setup_method == "manual":
        ...
        print("Managing all Relu services with Docker Compose...\n")
