...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Relu Team', url: 'https://www.relu.work' }],
  creator: 'Relu Team',
  publisher: 'Relu Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>Relu: Your Autonomous AI Worker</title>
        ...
        <meta name="keywords" content="Relu, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation" />
        <meta property="og:title" content="Relu: Your Autonomous AI Worker" />
        ...
        <meta property="og:image" content="https://relu.work/banner.png" />
        <meta property="og:url" content="https://relu.work" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Relu" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['Relu', 'Relu AI', 'Relu: Your Autonomous AI Worker'],
              url: siteMetadata.url,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'Relu'],
