#!/usr/bin/env python3
"""
Relu Service Manager

Starts and stops Relu services based on the setup method configured
...
def check_frontend_running() -> bool:
    """Check if the Relu frontend is running (not other Next.js apps like Cursor)."""
...
def check_backend_running() -> bool:
    """Check if the Relu backend is running."""
    root_dir = str(Path.cwd())
...
def show_help():
    ...
    print(__doc__)
    print("Commands:")
    print("  start     Start all Relu services")
    print("  stop      Stop all Relu services")
