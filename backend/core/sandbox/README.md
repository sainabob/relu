...
2. Build a custom image:
   ...
   docker push relu/suna:0.1.3.30
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `relu/suna:___`)
...
3. Push the new version: `docker push relu/suna:0.1.3`
