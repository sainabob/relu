...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'hey@relu.work')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Relu Team')
        self.hello_email = 'hello@relu.work'
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Relu — Let's Get Started "
    ...
    def send_referral_email(
        ...
        try:
            ...
            mail = mt.Mail(
                sender=mt.Address(email=sender_email_to_use, name='Relu'),
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://heprlhlltebrxydgtsjs.supabase.co/storage/v1/object/public/image-uploads/loaded_images/Profile%20Picture%20Black.png" alt="Relu Logo" class="logo">
    </div>
    ...
    <p>Thanks again, and welcome to the Relu community!</p>
  </div>
</body>
</html>"""
...
Welcome to https://www.relu.work/ — we're excited to have you on board!
...
Thanks again, and welcome to the Relu community!

---
© 2025 Relu. All rights reserved.
You received this email because you signed up for a Relu account."""
  ...
  <tr>
    <td>
      ...
      <p style="margin:0 0 20px 0; font-size:15px; line-height:1.6;">
        <strong>{sender_name}</strong> has invited you to join Relu using a personal referral code.
    ...
    <tr>
      <td>
        <div style="text-align: center; margin-bottom: 40px;">
          <img src="https://relu.work/Logomark.svg" alt="Relu" style="height: 24px; width: auto; display: inline-block;" />
        </div>
...
{sender_name} has invited you to join Relu using a personal referral code.
