...
DECLARE
    func_names TEXT[] := ARRAY[
        ...
        'count_relu_agents_by_version',
        'find_relu_default_agent_for_account',
        'get_all_relu_default_agents',
        'get_relu_default_agent_stats',
        'find_relu_agents_needing_update',
