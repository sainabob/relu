 ...
 * 
 * Note: The backend should return relu.work URLs that wrap/proxy Stripe,
...
// checkout URLs (should be relu.work masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a relu.work masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.relu.work/subscription';
