...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_relu_team:
            metadata['is_relu_team'] = True
            metadata['relu_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_relu_team: {template.is_relu_team}")
        return agent_id
