...
class DaytonaStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        if has_existing:
            ...
            self.info(
                "Relu REQUIRES Daytona for sandboxing functionality. "
        ...
        self.warning(
            "IMPORTANT: You must create a Relu snapshot in Daytona for it to work properly."
        )
        ...
        self.info("   - Name:          sainabob/relu:0.1.3.30")
        self.info("   - Snapshot name: sainabob/relu:0.1.3.30")
