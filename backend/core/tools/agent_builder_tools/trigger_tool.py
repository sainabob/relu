        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {
                        "type": "string",
                        "description": "Model to use for the scheduled execution. Options: 'relu/basic' (default, free tier) or 'relu/power' (requires paid subscription). If not specified, defaults to 'relu/basic'."
                    }
                },
        ...
        try:
            ...
            for trigger in schedule_triggers:
                formatted = {
                    ...
                    "model": trigger.config.get("model", "relu/basic"),
                    "is_active": trigger.is_active
                }
...
# Event trigger methods - available in all environments
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {"type": "string", "description": "Model to use for the event execution. Options: 'relu/basic' (default, free tier) or 'relu/power' (requires paid subscription). If not specified, defaults to 'relu/basic'."}
                },
    ...
    async def create_event_trigger(
        ...
        try:
            ...
            # Build Relu trigger config (same as API)
            relu_config: Dict[str, Any] = {
            ...
            if variables:
                relu_config["trigger_variables"] = variables
            ...
            try:
                ...
                logger.error(f"Failed to create Relu trigger: {e}")
                return self.fail_response(f"Failed to create Relu trigger: {str(e)}")
            ...
            message += f"**Model**: {relu_config['model']}\n"
