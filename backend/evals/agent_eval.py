...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Run Relu Agent evaluations",
...
Examples:
    ...
    parser.add_argument(
        "-m", "--model",
        type=str,
        default=os.getenv("EVAL_MODEL", "relu/basic"),
        help="Model to use (default: relu/basic)"
    )
...
""")
    ...
    # Run evaluation
    Eval(
        "Relu Agent",  # Project name in Braintrust
        data=get_eval_data,
