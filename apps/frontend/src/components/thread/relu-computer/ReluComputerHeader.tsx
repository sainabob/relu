...
interface ReluComputerHeaderProps {
...
/**
 * Shared header component for all Relu Computer views (Files, File Viewer, Browser).
 ...
 */
export function ReluComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
